...
SECRET_KEY = 'django-insecure-!)j%g_cm9k!yej*e=j_jv$uk0n9o0s+annng@@rj@ggn0=3@e('
...
EXTERNAL_IMAGES_DIR = os.path.join(BASE_DIR, "profile_images")
EXTERNAL_IMAGES_URL = "/profile_images/"
